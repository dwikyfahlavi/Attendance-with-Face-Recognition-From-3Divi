...
void writeFunc(Pointer<Void> stream, Pointer<Void> data, int bytesCount) {
  ...
  if (bytesCount != 0) {
    for (var i = 0; i < bytesCount; i++) {
      buffer_stream[1][currentByteCount.value + i] =
          Pointer<Uint8>.fromAddress(data.address + i).value;
    }
...
class Template extends _ComplexObject {
  Template(super.dll_handle, super.impl);
  ...
  String getMethodName() {
    ...
    final templateSave = _dll_handle.lookupFunction<_Template_get_method_name_c,
            _Template_get_method_name_dart>(
  ...
  Uint8List save() {
    ...
    final templateSave =
        _dll_handle.lookupFunction<_Template_save_c, _Template_save_dart>(
