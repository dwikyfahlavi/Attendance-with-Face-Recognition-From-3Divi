...
class LivenessResult {
  ...
  String toString() {
    ...
    if (verdict == 0) {
      ...
      intrepretable_verdict = "Not computed";
    }
...
class Liveness2DEstimator extends _ComplexObject {
  Liveness2DEstimator(super.dll_handle, super.impl);
  ...
  LivenessResult estimateLiveness(final RawSample sample) {
    final process = _dll_handle.lookupFunction<
            _Liveness2DEstimator_estimateLiveness,
            _Liveness2DEstimator_estimateLiveness>(
        '${_c_namespace}Liveness2DEstimator_estimateLiveness');
    Pointer<Int32> verdictPtr =
