// ignore_for_file: non_constant_identifier_names, prefer_final_fields, prefer_typing_uninitialized_variables
...
class _ComplexObject {
  ...
  _ComplexObject(DynamicLibrary dll_handle, Pointer<Void> impl)
      : _dll_handle = dll_handle,
        _impl = impl,
        _destructor =
            dll_handle.lookupFunction<_objDestructor_c, _objDestructor_dart>(
                '${_c_namespace}apiObject_destructor');
