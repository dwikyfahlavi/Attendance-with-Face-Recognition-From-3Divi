...
class TemplateIndex extends _ComplexObject {
  TemplateIndex(super.dll_handle, super.impl);
  ...
  Template at(int t) {
    ...
    final getAt = _dll_handle.lookupFunction<_Templates_index_at_c,
        _Templates_index_at_dart>('${_c_namespace}TemplatesIndex_at');
  ...
  int size() {
    var exception = _getException();
    final getSize = _dll_handle.lookupFunction<_Templates_index_size_c,
        _Templates_index_size_dart>('${_c_namespace}TemplatesIndex_size');
  ...
  void reserveSearchMemory(int queries_count) {
    var exception = _getException();
    final _reserveSearchMemory = _dll_handle.lookupFunction<
            _Templates_index_reserve_search_memory_c,
            _Templates_index_reserve_search_memory_dart>(
